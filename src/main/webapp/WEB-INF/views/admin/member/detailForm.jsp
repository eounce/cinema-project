...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form name="updateForm" action="/admin/members/${member.id}/edit" method="GET">
            </form>
            <form name="deleteForm" action="/admin/members/${member.id}/del" method="POST">
                <input type="hidden" name="_method" value="delete" />
            </form>
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary"><a href="/admin/members"><i class="fas fa-user-friends"> Member</i></a>
                    <a href='#' class="btn btn-primary float-right" onclick="location.href='/admin/members'"><i class="fas fa-undo"></i></a>
            ...
            <div class="card-body">
                <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" class="form-control" name="id" value="${member.id}" disabled>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <%
                        ...
                        String subscription_date = df.format(member.getSubscription_date());
                    %>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <c:if test="${not empty member.image}">
                                <img src="/admin/members/images/${member.image}" style="max-height: 200px;max-width: 100%">
                            </c:if>
                        </td>
                    </tr>
                    </tbody>
