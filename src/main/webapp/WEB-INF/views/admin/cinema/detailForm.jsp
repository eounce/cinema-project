            ...
            <div class="card-body">
                <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" class="form-control" name="name" value="${cinema.cinemaCity.cityName}" disabled>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" class="form-control" name="name" value="${cinema.introduction}" disabled>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="20%" style="vertical-align:middle;">Address</th>
                        <td width="80%">
                            <input type="text" class="form-control" name="name" value="${cinema.address}" disabled>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="20%" style="vertical-align:middle;">Sales</th>
                        <td width="80%">
                            <input type="text" class="form-control" name="name" value="${cinema.sales}" disabled>
                        </td>
                    </tr>
                    </tbody>
                </table>
