...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form method="post" action="/cinema/admin/citys/update/${city.id}">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary"><i class="fas fa-city"><a href="/cinema/admin/citys" style="text-decoration:none"> City</a></i>
                        <a href='#' class="btn btn-primary float-right" onclick="location.href='/cinema/admin/citys/${city.id}'"><i class="fas fa-undo"></i></a>
