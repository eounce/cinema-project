            ...
            <div class="card-body">
                <table class="table table-bordered table-striped" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" class="form-control" name="name" value="${theater.theaterCinema.cinemaName}" disabled>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row" width="20%" style="vertical-align:middle;">Seat_Count</th>
                        <td width="80%">
                            <input type="text" class="form-control" name="name" value="${theater.seat_count}" disabled>
                        </td>
                    </tr>
                    </tbody>
                </table>
