...
<div id="wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <form name="updateForm" action="/cinema/admin/theaters/update/${theater.id}" method="GET">
            </form>
            <form name="deleteForm" action="/cinema/admin/theaters/del/${theater.id}" method="POST">
                <input type="hidden" name="_method" value="delete" />
            </form>
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary"><i class="fas fa-video"><a href="/cinema/admin/theaters" style="text-decoration:none"> Cinema</a></i>
                    <a href='#' class="btn btn-primary float-right" onclick="location.href='/cinema/admin/theaters'"><i class="fas fa-undo"></i></a>
